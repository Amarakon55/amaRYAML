...
1. Diplôme d'études secondaires ou l'équivalent avec un minimum de six cours U ou M de 12e année, incluant tous les cours obligatoires.
1. Les cours U ou M de 12e année doivent être suivis dans des écoles accréditées par le ministère de l'Éducation de l'Ontario.
1. Les moyennes d'admission dépendent du nombre de candidatures reçues et du nombre de places disponibles. La fourchette indiquée ci-dessus est basée sur les années précédentes.
1. Les cours répétés peuvent être pris en considération selon le programme.
...
- J'ai utilisé du code pour [faire cette brochure](https://github.com/amarakon/amaryaml/blob/master/inst/examples/brochure/brochure.Rmd).
