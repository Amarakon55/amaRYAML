...
```{r templates}
one = c("![leaflet [1/2]](inst/examples/leaflet/leaflet-1.png)")
two = c("![leaflet [2/2]](inst/examples/leaflet/leaflet-2.png)")

templates = data.frame(one, two)

kable(templates, align = 'cc', col.name = c("[leaflet [1/2]](inst/examples/leaflet/leaflet.pdf)", "[leaflet [2/2]](inst/examples/leaflet/leaflet.pdf)"))
```
